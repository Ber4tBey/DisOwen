...
module.exports.run = async (bot, message, args) => {
  ...
  if(message.isMemberMentioned(bot.user)) return Owen.editmsg(message,Lang.NOT_GBAN_ME);
  ...
  if(a == replymsg.id) {
      Owen.editmsg(message,Lang.GBAN_AV);
  } else {
   await Db.addgban(replymsg.id)
   Owen.editmsg(message,Lang.GBAN_SUCCES)
